...
$api         = $on_nitrous ? "/api/" : "/api/index.php/";
$db_server   = "localhost";
$db_user     = "root";
$db_password = "";
$db_name     = $on_nitrous ? "AT.v1.0" : "at_v1";
...
if (startsWith( $endpoint, "jobs")) {
  ...
  if ($method== "GET") {
    // e.g.: https://elabs-02-130234.usw1-2.nitrousbox.com/api/jobs?tenant=sp&limit=10&order-by=score&order-mode=DESC
